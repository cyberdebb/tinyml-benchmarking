// Board bring-up for the NUCLEO-F767ZI: everything main() needs before the
// TinyML app runs. On the ESP32 the ESP-IDF startup code does all of this,
// which is why its main.c is only the call to tinyml_app_main().
#include <stdio.h>
...
// newlib calls this for printf: send the bytes over USART3.
